...
class DynamicComponentDirective {
    ...
    ngOnChanges(changes) {
        ...
        componentChanges !== null && componentChanges !== void 0 ? componentChanges : (componentChanges = this.makeComponentChanges(changes['inputs'], false));
        assertNotNullOrUndefined(this.componentRef);
        if (changes['inputs']) {
            this.bindInputs(this.componentRef.instance, (_a = this.inputs) !== null && _a !== void 0 ? _a : {}, this.componentRef.instance);
        }
    ...
    makeComponentChanges(inputsChange, firstChange) {
        var _a, _b;
        const previousInputs = (_a = inputsChange === null || inputsChange === void 0 ? void 0 : inputsChange.previousValue) !== null && _a !== void 0 ? _a : {};
        const currentInputs = (_b = inputsChange === null || inputsChange === void 0 ? void 0 : inputsChange.currentValue) !== null && _b !== void 0 ? _b : {};
    ...
    transform(value, key) {
        return new Observable((observer) => {
            this.service.getDynamicPagesConfig()
                .subscribe(config => {
                var _a;
                let findComponent = (_a = config === null || config === void 0 ? void 0 : config.storeComponents.find((comp) => comp.key === key)) === null || _a === void 0 ? void 0 : _a.component;
